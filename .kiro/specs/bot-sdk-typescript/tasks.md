...
- [ ] 2. Implement core types and error classes
  - [ ] 2.1 Create types.ts with all TypeScript interfaces
  ...
  - [ ] 2.2 Create errors.ts with custom error classes
...
- [ ] 3. Implement Bot Client class
  - [ ] 3.1 Create bot.ts with Bot class constructor
  ...
  - [ ] 3.3 Implement start() method for WebSocket mode
    - Create WebSocketManager instance
    - Call connect() and handle ready event
    - Set isRunning flag
    - _Requirements: 2.1_

  - [ ] 3.4 Implement startWebhook() method for webhook mode
    - Create WebhookServer instance
    - Start server on specified port and path
    - Set isRunning flag
    - _Requirements: 3.1_

  - [ ] 3.5 Implement stop() method for graceful shutdown
  ...
  - [ ] 3.7 Implement handler registration methods (on, command, use)
  ...
  - [ ] 3.8 Implement sendMessage() method
...
- [ ] 5. Implement API Client with retry logic
  - [ ] 5.1 Create api-client.ts with ApiClient class
    - Initialize axios client with baseURL and timeout
    - Store token, retry configuration, and logger
    - _Requirements: 7.1, 13.1_

  - [ ] 5.2 Implement sendMessage() method
  ...
  - [ ] 5.4 Implement requestWithRetry() method
...
- [ ] 6. Implement Context class
  - [ ] 6.1 Create context.ts with Context class
  ...
  - [ ] 6.3 Implement button validation in replyWithButtons()
...
- [ ] 8. Implement Update Router
  - [ ] 8.1 Create update-router.ts with UpdateRouter class
    - Initialize handler arrays and maps
    - Store apiClient and logger references
    - _Requirements: 4.1, 4.2, 4.3, 5.1_

  - [ ] 8.2 Implement on() method for handler registration
  ...
  - [ ] 8.5 Implement use() method for middleware registration
    - Add middleware to middlewares array
    - _Requirements: 9.1_

  - [ ] 8.6 Implement route() method
  ...
  - [ ] 8.8 Implement runHandlers() method
...
- [ ] 10. Implement WebSocket Manager
  - [ ] 10.1 Create websocket-manager.ts with WebSocketManager class
    - Store token, wsUrl, updateRouter, logger
    - Initialize reconnection state variables
    - _Requirements: 2.1_

  - [ ] 10.2 Implement connect() method
  ...
  - [ ] 10.3 Implement handleMessage() method
  ...
  - [ ] 10.5 Implement scheduleReconnect() method
...
- [ ] 12. Implement Logger
  - [ ] 12.1 Implement ConsoleLogger in types.ts
...
- [ ] 13. Create public exports and documentation
  - [ ] 13.1 Create index.ts with public exports
    - Export Bot class
    - Export all types and interfaces
    - Export error classes
    - _Requirements: 11.1_

  - [ ] 13.2 Write README.md with usage examples
    - Quick start guide
  ...
  - [ ] 13.3 Write API documentation comments (JSDoc)
    - Document all public methods and properties
    - Include parameter descriptions and return types
    - Add usage examples in comments

- [ ] 14. Final checkpoint - Integration testing
  - [ ] 14.1 Write integration test for WebSocket mode
    - Test full connection and message flow
    - Test reconnection behavior
    - Test graceful shutdown

  - [ ] 14.2 Write integration test for webhook mode
    - Test webhook server startup
    - Test update processing
    - Test graceful shutdown

  - [ ] 14.3 Write integration test for end-to-end message flow
